            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 14:
                        ...
                        return [4 /*yield*/, util_2.getConnectorWithDatabase(__assign({}, intermediateConnectorData, { databaseType: credentials.type }), this)];
                    case 15:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_q) {
                switch (_q.label) {
                    ...
                    case 18:
                        if (!(type === prisma_datamodel_1.DatabaseType.mongo)) return [3 /*break*/, 23];
                        _m = credentials;
                        return [4 /*yield*/, this.ask({
                    ...
                    case 21:
                        alreadyData = _o;
                        if (!alreadyData) return [3 /*break*/, 23];
                        _p = credentials;
                        return [4 /*yield*/, this.ask({
                    ...
                    case 22:
                        _p.database = _q.sent();
                        _q.label = 23;
                    case 23: return [2 /*return*/, credentials];
                }
            });
        });
    };
