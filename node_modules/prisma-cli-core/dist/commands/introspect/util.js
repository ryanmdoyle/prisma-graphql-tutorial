...
function getConnectorWithDatabase(connectorData, endpointDialog) {
    return __awaiter(this, void 0, void 0, function () {
        var connector, disconnect, databaseType, result, databaseName, schemas, e_1, schemaWord;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    connector = connectorData.connector, disconnect = connectorData.disconnect, databaseType = connectorData.databaseType, result = __rest(connectorData, ["connector", "disconnect", "databaseType"]);
