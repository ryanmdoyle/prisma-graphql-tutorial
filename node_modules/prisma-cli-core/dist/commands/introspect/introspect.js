...
var IntrospectCommand = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _b = _c.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, introspection.getDatamodel()];
                    case 4:
                        _b = _c.sent();
                        _c.label = 5;
                    case 5:
    ...
    IntrospectCommand.prototype.getConnector = function () {
        return __awaiter(this, void 0, void 0, function () {
            var hasExecuteRaw, credentials, _a, connector_1, disconnect_1, client, connector, disconnect, databaseDivider, databaseName;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.hasExecuteRaw()];
                    case 1:
                        hasExecuteRaw = _b.sent();
                        return [4 /*yield*/, this.getCredentials(hasExecuteRaw)];
                    case 2:
                        credentials = _b.sent();
                        if (!credentials) return [3 /*break*/, 4];
    ...
    IntrospectCommand.prototype.getCredentials = function (hasExecuteRaw) {
        return __awaiter(this, void 0, void 0, function () {
            var requiredPostgresFlags, requiredMysqlFlags, flags, flagsKeys, mysqlFlags, postgresFlags, endpointDialog;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        requiredPostgresFlags = ['pg-host', 'pg-user', 'pg-password', 'pg-db'];
                        requiredMysqlFlags = ['mysql-host', 'mysql-user', 'mysql-password'];
                        flags = this.getSanitizedFlags();
                        flagsKeys = Object.keys(flags);
                        mysqlFlags = flagsKeys.filter(function (f) { return requiredMysqlFlags.includes(f); });
                        postgresFlags = flagsKeys.filter(function (f) {
                        ...
                        if (flags['mongo-uri']) {
                            return [2 /*return*/, {
                                    uri: flags['mongo-uri'],
                                    schema: flags['mongo-db'],
                                    type: prisma_datamodel_1.DatabaseType.mongo,
                                }];
                        }
                        if (!(flags.interactive || !hasExecuteRaw)) return [3 /*break*/, 2];
                        endpointDialog = new EndpointDialog_1.EndpointDialog({
                            out: this.out,
                            client: this.client,
                            env: this.env,
